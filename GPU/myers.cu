...
__device__ long advancedBlock(const bitvector_64*, const bitvector_64*, const bitvector_64*, unsigned int, bitvector_64*, bitvector_64*, bitvector_64*, bitvector_64*, bitvector_64*, bitvector_64*, const unsigned short int, const unsigned int);

void* preprocessingPEq(bitvector_64**, const char*, const unsigned int, const unsigned int, const unsigned short int);

__global__ void myers_kernel(const bitvector_64*, const unsigned int, const unsigned int, bitvector_64*, bitvector_64*, bitvector_64*, bitvector_64* HX, bitvector_64*, bitvector_64*, const bitvector_64*, const bitvector_64*, const unsigned int, const unsigned int k, boolean*, const char*, const unsigned int, const unsigned int, const unsigned short int, const unsigned int );
...
boolean* myers(char *t, unsigned int n, char *p, unsigned int m, unsigned int k, const unsigned int alphabet_lenght, const unsigned int device, const unsigned int threads_per_block)
{
	...
	myers_kernel<<<numBlocks, threadsPerBlock>>>(d_PEq, slice_base, remaining, d_VP, d_VN, d_VX, d_HX,
...
__global__ void myers_kernel(const bitvector_64* PEq,
							 ...
							 const unsigned int alphabet_lenght)
{
	...
	for(j = 0; j < length; j++)
	{
		...
		score += advancedBlock(PEq, MMASK, HMASK, (unsigned int) t[position], VP + bitvector_start, VN + bitvector_start, VX + bitvector_start, HX + bitvector_start, HP + bitvector_start, HN + bitvector_start, n_blocks, alphabet_lenght);
...
__device__ long advancedBlock(const bitvector_64* PEq,
	 						const bitvector_64* MMASK,
	 						const bitvector_64* HMASK,
